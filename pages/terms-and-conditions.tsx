  ...
  <Layout title="Terms and Conditions | Not Dead Yet">
    ...
    >
      ...
      <p>
        ...
        continue to use Not Dead Yet if you do not agree to take all of the terms and
        conditions stated on this page.
      </p>

      <p>
        The following terminology applies to these Terms and Conditions and our Priacy
        Policy: &quot;You&quot; and &quot;Your&quot; refers to you and the person who has
        signed into this website and compliant to the website&quot;s terms and conditions.
        &quot;Organization&quot;, &quot;Ourselves&quot;, &quot;We&quot;, &quot;Our&quot;
        and &quot;Us&quot;, refers to our gaming esports organization/group (the members
        of our World of Warcraft guild). Any use of the above terminology or other words
      ...
      <p>
        We employ the use of cookies. By accessing Not Dead Yet, you agreed to use cookies
        in agreement with the Not Dead Yet&apos;s Privacy Policy.
      </p>

      <p>
        Most interactive websites use cookies to let us retrieve the user&apos;s details
        for each visit to maintain logged in sessions. Cookies are used by our website to
      ...
      <p>
        ...
        property rights for all material on Not Dead Yet. All intellectual property rights
        are reserved. You may access this from Not Dead Yet for your own personal use
      ...
      <p>
        ...
        applications for applying to our Organization. Not Dead Yet does not filter, edit,
        publish or review these applications and Comments prior to their presence on the
        website. None of the submitted Applications, nor their Comments, reflect the views
        and opinions of Not Dead Yet. Applications and Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, Not Dead Yet shall not be liable for the Comments or for any
      ...
      <ul>
        <li>
          You are entitled to post any Application or Comment on our website and have all
          necessary licenses and consents to do so;
        </li>
        <li>
          The Application/Comment does not invade any intellectual property right,
          including without limitation copyright, patent or trademark of any third party;
        </li>
        <li>
      ...
      <p>
        You hereby grant Not Dead Yet a non-exclusive license to use, reproduce, edit and
        authorize others to use, reproduce and edit any of your Applications or Comments
